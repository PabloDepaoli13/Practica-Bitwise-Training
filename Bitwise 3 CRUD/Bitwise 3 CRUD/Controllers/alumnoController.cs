...
namespace Bitwise_3_CRUD.Controllers
{
    ...
    public class alumnoController : ControllerBase
    {
        ...
        public async Task<IActionResult> ObtenerTablas()
        {
            ...
            try
            {
                ...
                return Ok(new { message = "Completado", lista });
            }
        ...
        public async Task<IActionResult> ObtenerTabla(int id)
        {
            ...
            try
            {
                using (var conexion = new SqlConnection(cadenaSQL))
                {
                    ...
                    return Ok(new { message = "Ok", alumno });
                }
            }
            catch (Exception error)
            {
        ...
        public async Task<IActionResult> EnviarAlumno(alumno alumno)
        {
            try
            {
                using (var conexion = new SqlConnection(cadenaSQL))
        ...
        public async Task<IActionResult> CambiarAlumno(int id, alumno alumno)
        {
            try
            {
                ...
                return StatusCode(StatusCodes.Status200OK, new {message = "Corregido"});
            }
            catch (Exception error)
            {
                return StatusCode(StatusCodes.Status500InternalServerError, new { message = error.Message });
